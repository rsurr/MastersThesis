...
predict p_hat`j'
replace hab_op=26 if ZCAIMAE=="HOSPITAL DE CLINICAS"
predict p_sim`j'
replace hab_op=actual_hab_op
...
export delimited using "simulacion3.csv", nolab replace
